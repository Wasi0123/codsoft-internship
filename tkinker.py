...
class TodoListApp(tk.Tk):
    def __init__(self):
        ...
        self.task_input = ttk.Entry(self, font=(
            "TkDefaultFont", 18), width=40, style="Custon.TEntry")
        self.task_input.pack(pady=10)

        # Set placeholder for input field
        self.task_input.insert(0, " Enter what you want to do here....")
        ...
        ttk.Button(self, text="finished", style="success.TButton",
    ...
    def view_stats(self):
        ...
        for i in range(total_count):
            if self.task_list.itemcget(i, "fg") == "blue":
                done_count += 1
